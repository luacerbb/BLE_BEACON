...
#define SCAN_INTERVAL_MS  2000//100//1000 ///100 houtest
#define WINDOW_LEN_MS    	1100//25//500			//(SCAN_INTERVAL_MS / 4)
...
void app_beacon_scanner_init(ble_beacon_scanner_init_t * p_init)
{
    ...
    m_beacon_scanner.scan_params.active      = true;
    ...
    m_beacon_scanner.scan_params.timeout     = 2; // disable timeout
}
